...
function SidebarMenuAdmin() {
  ...
  const { userPriority, userData } = useContext(UserPriorityContext);
  ...
  console.log("deposit===>",badgeNumber);
  console.log("withdraw===>",withdrawbadgeNumber);
              ...
              <List component="div">
                <ListItem component="div">
                  <Button
                    ...
                    component={RouterLink}
                    onClick={closeSidebar}
                    to="/admin/app/request/depositrequest"
                  >
                    <Badge badgeContent={badgeNumber} color="primary">
                      <NotificationsActiveIcon sx={{ color: "#af8b05" }} />
                    </Badge>
                    <Typography
                      sx={{
              ...
              <List component="div">
                <ListItem component="div">
                  <Button
                    ...
                    component={RouterLink}
                    onClick={closeSidebar}
                    to="/admin/app/request/withdrawalrequest"
                  >
                    <Badge badgeContent={withdrawbadgeNumber} color="primary">
                      <NotificationsActiveIcon sx={{ color: "#af8b05" }} />
                    </Badge>
                    <Typography
                      sx={{
            ...
            <List component="div">
              <ListItem component="div">
                <Button
                  ...
                  component={RouterLink}
                  onClick={closeSidebar}
                  to="/admin/app/management/deposithistory"
            ...
            <List component="div">
              <ListItem component="div">
                <Button
                  ...
                  component={RouterLink}
                  onClick={closeSidebar}
                  to="/admin/app/management/withdrawalhistory"
