...
export class Client implements IClient {
    ...
    credit_approve_deposit_post(body: DepositApprove): Promise<DepositApprovedResponse> {
        let url_ = this.baseUrl + "/api/credit/manage/approve_deposit";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processCredit_approve_deposit_post(_response);
        });
    }

    protected processCredit_approve_deposit_post(response: Response): Promise<DepositApprovedResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as DepositApprovedResponse;
            return result200;
            });
        } else if (status === 422) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<DepositApprovedResponse>(null as any);
    }

    // Reject Depost
    // @return succesful response

    credit_reject_deposit_post(body: DepositApprove): Promise<DepositApprovedResponse> {
        let url_ = this.baseUrl + "/api/credit/manage/reject_deposit";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processCredit_reject_deposit_post(_response);
        });
    }

    protected processCredit_reject_deposit_post(response: Response): Promise<DepositApprovedResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    credit_approve_withdrawal_post(body: DepositApprove): Promise<DepositApprovedResponse> {
        let url_ = this.baseUrl + "/api/credit/manage/approve_withdraw";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processCredit_approve_withdrawal_post(_response);
        });
    }

    protected processCredit_approve_withdrawal_post(response: Response): Promise<DepositApprovedResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    credit_reject_withdrawal_post(body: DepositApprove): Promise<DepositApprovedResponse> {
        let url_ = this.baseUrl + "/api/credit/manage/reject_withdraw";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processCredit_reject_withdrawal_post(_response);
        });
    }

    protected processCredit_reject_withdrawal_post(response: Response): Promise<DepositApprovedResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    credit_GetUser_withdrawal_post(body: DepositHistorySchema): Promise<DepositHistoryResponse> {
        let url_ = this.baseUrl + "/api/credit/manage/get_user_withdrawals";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processCredit_GetUser_withdrawal_post(_response);
        });
    }

    protected processCredit_GetUser_withdrawal_post(response: Response): Promise<DepositHistoryResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as DepositHistoryResponse;
            return result200;
            });
        } else if (status === 422) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<DepositHistoryResponse>(null as any);
    }

    // Get user deposit history
    // @return succesful response

    credit_GetUser_Deposit_post(body: DepositHistorySchema): Promise<DepositHistoryResponse> {
        let url_ = this.baseUrl + "/api/credit/manage/get_user_deposits";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processCredit_GetUser_Deposit_post(_response);
        });
    }

    protected processCredit_GetUser_Deposit_post(response: Response): Promise<DepositHistoryResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
// It's a model that is used to represent a approve request.

export interface DepositApprove{
    ownId:string;
    id?:string;
    approvedById?:string
...
export interface DepositApprovedResponse{
    success: boolean;
    error?: string;
    response?: DepositApproveResponseSchema
...
export interface DepositApproveResponseSchema{
    id?: string;
    amount?: number;
...
export interface DepositStatusSchema{
    approvedById?: string;
    approval?: string;
...
//It's a model that represent a deposit history request

export interface DepositHistorySchema{
    context?: DepositHistoryContext;
    params?: Params;
}

export interface DepositHistoryContext{
...
export interface DepositHistoryResponse{
    success: boolean;
    error?: string;
    response: DepositHistoryItem
}

export interface DepositHistoryItem{
    items?: DepositHistoryItemContent[];
    page?: number;
    pageSize?:number;
    pages?:number;
    total?:number;
...
export interface DepositHistoryItemContent{
    id?: string;
    amount?:number;
    owner?: App__api__credit__schema__User;
    status?: DepositStatusSchema;
